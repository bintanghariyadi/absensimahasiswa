    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          ...
          <form action="<?php echo base_url('web/fungsieditabsensi') ?>" method="post" class="form-jadwal">
            <div class="form-group">
                <label for="idabsensi">Id Absensi</label>
                <input type="number" class="form-control" name="idabsensi" value="<?php echo $queryabsdetail->idabsensi ?>" readonly>
</div>
<div class="form-group">
                <label for="idjadwal">Id Jadwal</label>
                <input type="number" class="form-control" name="idjadwal" value="<?php echo $queryabsdetail->idjadwal ?>" readonly>
</div>
<div class="form-group">
                <label for="nim">Nim</label>
                <input type="number" class="form-control" name="nim" value="<?php echo $queryabsdetail->idjadwal ?>" readonly>
</div>
<div class="form-group">
